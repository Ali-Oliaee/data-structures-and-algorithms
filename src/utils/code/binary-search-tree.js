...
<<<<<<< HEAD
  ...
  if(data < leaf->data) leaf->Lchild = r;
  else leaf->Rchild = r;
  return true;
}`,
=======
...
>>>>>>> 20b2b56 (improve max heap functionality)
    ...
    codes: [
      {
        ...
        code: `Node* BST::recSearch(Node* Root, int key){
  ...
  if(n != NULL){
      ...
      {
        subtitle: "Postorder",
        code: `void BST::Postorder(Node *n){
  if(n != NULL){
    inorder(n->Lchild);
    inorder(n->Rchild);
    std::cout << n->data << " ";
      ...
      {
        subtitle: "Levelorder",
        code: `void BST::Levelorder(Node *n){
  Queue Q = new Queue();
  Btree n;
  ...
  },
  {
    ...
    codes: [
      {
        subtitle: "successor",
        code: `Node* BST::successor(int key){
    ...
    codes: [
      {
        ...
        code: `void BST::printOddNodes(Node *Root, bool isOdd = true){
  // If empty tree
  if (Root == NULL) return;
    ...
    codes: [
      {
        ...
        code: `int BST::getLeafCount(Node* Root){
  if(Root == NULL)
    return 0;
